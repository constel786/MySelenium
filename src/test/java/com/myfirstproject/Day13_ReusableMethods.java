...
//        daySelect.selectByIndex(5);//using index to select day 5. index starts at 0.
        selectByVisibleText(driver.findElement(By.xpath("//select[@data-qa='days']")),"5");
//        MONTH
...
//        monthSelect.selectByValue("5");//using value to select May
        selectByVisibleText(driver.findElement(By.cssSelector("select[data-qa='months']")),"May");
//        YEAR
...
//        yearSelect.selectByVisibleText("2000");//using visible text to select 2000
        selectByVisibleText(driver.findElement(By.cssSelector("select[data-qa='years']")),"2000");
...
//        countrySelect.selectByVisibleText("United States");
        selectByVisibleText(driver.findElement(By.id("country")),"United States");
//        state
